...
load('camParamsSamsung.mat')
cameraParams = cameraParamsSam;
...
%Find the cylinder in the point cloud by fitting a cylinder to the 3-D points 
%using the pcfitcylinder function.

% Detect the cylinder
cylinder = pcfitcylinder(ptCloud, 0.005);

% Display the surface of the cylinder
plot(cylinder);
title('Estimated Location and Size of the Cylinder');
hold off
