...
folder=strcat(pwd,'\fotos\fotos cam tele fornada 2\');
addpath(folder)
% folder=strcat(pwd,'\fotos cam tele\');
% addpath(folder)
% folder=strcat(pwd,'\fotos lab\');
% addpath(folder)
% folder=strcat(pwd,'\fotos\');
% addpath(folder)
...
%Fotos do Rari:
I1 = imread('DSC_0001.jpg');
I2 = imread('DSC_0002.jpg');
...
% I1 = imread('DSC_0055.jpg');
% I2 = imread('DSC_0056.jpg'); 
% I1 = imread('DSC_0090.jpg');
% I2 = imread('DSC_0091.jpg'); 

% I1 = imread('DSC_0104.jpg');
% I2 = imread('DSC_0105.jpg'); 
